...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mLabelsColorShadow;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsColorShadow = attr.getColor(R.styleable.FloatingActionButton_fab_shadowColor,0x66000000);
        ...
        if (iconRes != 0) {
            ...
            mIcon = AppCompatResources.getDrawable(context,R.drawable.ic_add_black_24dp);
        }
        mIconClose = AppCompatResources.getDrawable(context,R.drawable.ic_add_black_24dp);
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        label.setFab(fab,mLabelsColorShadow);
