...
/**
 * Created by Arunavo Ray on 12-06-2018.
 */
...
fun compareDrawableBytes(x: Drawable, y: Drawable):Boolean {
    return x.bytesEqualTo(y)
}

fun compareDrawablePixels(x: Drawable, y: Drawable):Boolean {
    return x.pixelsEqualTo(y)
}
