...
import com.firebase.ui.auth.ui.intro.IntroAdapter;
...
public class AuthMethodPickerActivity extends AppCompatBase {
    ...
    private ViewGroup mProviderHolderEmail;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fui_auth_method_picker_layout_new);

        mProgressBar = findViewById(R.id.top_progress_bar);
        mProviderHolder = findViewById(R.id.btn_holder);
        mProviderHolderEmail = findViewById(R.id.btn_holder_email);

        mViewPager = (ViewPager) findViewById(R.id.intro_pager);
        IntroAdapter mPagerAdapter = new IntroAdapter(getSupportFragmentManager(),this);
    ...
    private void populateIdpList(List<IdpConfig> providerConfigs,
        ...
        for (IdpConfig idpConfig : providerConfigs) {
            ...
            if (providerId.equals(EmailAuthProvider.PROVIDER_ID)){
                mProviderHolderEmail.addView(loginButton);
            }else {
